...
public class Jeu extends BasicGame{
	...
	public void renderJeu(GameContainer gc, Graphics grphcs) {
		grphcs.translate(-personnage.getImg_caseX()+600, 0); // camera qui suit le personnage avec 400px entre le botd gauche et le personnage
		map.renderMap(); //initailisation de la maps
